  ...
  const str = e.target.innerText;
    ...
    switch(str){
      ...
      case "append" :
        ...
        span2.appendChild(text2); // span2의 자식으로 text node 생성
        span2.style.backgroundColor = "lightsalmon";
        standard.append(span2); // standarad의 마지막 자식으로 span2 추가 
     break;
     ...
     case "before":
      ...
      div1.innerText = count; // div의 내용으로 count 추가(TextNode 사용 안하는 방법)
      standard.before(div1); // #standard 앞쪽에 생성
     break;
     ...
     case "after":
      ...
      for(let span of spans){
        span.remove(); // 선택된 요소(#stnadard > span) 삭제
      }
      count = 0; // 카운트 초기화
