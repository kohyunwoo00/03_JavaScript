...
{ // 함수 정의 시작
  ...
  if(num1 === 100){
    var num2 = 200; // var를 이요해서 num2 변수를 선언
  // var는 함수 레벨 범위
  // -> var는 함수 정의 시작 ~ 끝 사이에 존재하면 어디서든 사용 가능(함수 종료 직전까지 사용 가능)
  }
...
function typeCheck(){
  ...
  console.log(sumFn(111, 113));
  console.log(sumFn(9999, 133));
  console.log(sumFn(1425, 11648));
