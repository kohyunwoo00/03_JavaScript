...
calc.addEventListener("click", () => {
  // 계산 버튼이 클릭되는 시점에 존재하는 .input-number 요소를 모두 얻어와 작성된 값의 합계를 구해서 출력하기
...
addBtn.addEventListener("click", () => {
  // 추가버튼 클릭 시
  // div, input, span 요소를 만들어서 알맞게 조립 후 .container의 마지막 자식으로 추가
  ...
  /* ********************************************* */
  // div, input, spandmf dkfakwrp whflq
