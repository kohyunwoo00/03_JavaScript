...
/* Number(input1.value)가 계속 반복되는데 전역변수로 선언하면 안될까?
    ...
    -> (해결 방법) 값을 입력한 후 함수를 호출해서 함수가 호출되는 시점의 입력된 값을 읽어올 수 있게 만든다 */
...
// ex) +,-,*,/,%, ++, --, 변수에 값 대입, console 출력, innerText ... 모두 다 
function checkFn(){
